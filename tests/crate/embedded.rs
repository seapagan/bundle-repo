...
const DEEPSEEK_V3_SHA256: [u8; 32] = [
    0x62, 0x1a, 0xc2, 0xe3, 0x2d, 0x0d, 0xba, 0x65, 0x84, 0x04, 0x41, 0x23,
    0x18, 0x81, 0x8a, 0xaa, 0x8c, 0xe8, 0xcd, 0xa4, 0x92, 0xe5, 0x98, 0x30,
    0x10, 0x9d, 0x8d, 0xa6, 0xb5, 0x17, 0xfb, 0x41,
];
const DEEPSEEK_R1_SHA256: [u8; 32] = [
    0xec, 0xb6, 0xf9, 0xfc, 0x36, 0x98, 0x94, 0x34, 0x6f, 0x05, 0x11, 0xf4,
    0x07, 0x4c, 0xa7, 0x5c, 0xee, 0x5c, 0xd5, 0xf3, 0xb0, 0x6d, 0x02, 0xf1,
    0xba, 0x35, 0xfc, 0xd3, 0x9f, 0x8e, 0x12, 0x1d,
];
const DEEPSEEK_V4_SHA256: [u8; 32] = [
    0x8f, 0x9f, 0x37, 0xca, 0x37, 0xfd, 0xc4, 0xf5, 0xfd, 0x36, 0xd5, 0xcf,
    0x4d, 0x3b, 0x0e, 0x83, 0x92, 0xed, 0xb4, 0xe8, 0x94, 0xfd, 0x10, 0xcc,
    0x0d, 0x70, 0xb4, 0x95, 0x7c, 0x86, 0x33, 0xcf,
];
const GLM5_2_SHA256: [u8; 32] = [
    0x19, 0xe7, 0x73, 0x64, 0x8c, 0xb4, 0xe6, 0x5d, 0xe8, 0x66, 0x0e, 0xa6,
    0x36, 0x5e, 0x10, 0xac, 0xca, 0x11, 0x2d, 0x42, 0xa8, 0x54, 0x92, 0x3d,
    0xf9, 0x3d, 0xb4, 0xa6, 0xf3, 0x33, 0xa8, 0x2d,
];
...
fn test_runtime_resources_include_only_tokenizer_json() {
    ...
    assert!(Resources::get("tokenizers/licenses/DeepSeek-MIT.txt").is_none());
}
